...
<br><br>
        ...
        <?php foreach($rows as $row){?>
            <div class="md:flex md:items-center mb-6">
              ...
              <div class="md:w-2/3">
  <textarea name="<?php echo $row[0]?>" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="<?php echo $row[0]?>"></textarea>
  </div> <?php }else{?>
              <div class="md:w-2/3">
                <input name="<?php echo $row[0]?>" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text">
              </div>
            <?php }?>
            </div>
            <hr>
            ...
            <div class="md:flex md:items-center">
              ...
              <div class="md:w-2/3">
                <button type="submit"  name="addNew" class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                  SUBMIT
                </button>
              </div>
            </div>
